...
insert into aj_hospital_table
 ...
 insert into aj_hospital_table
 values
 (6, 'Anand', 'Banglore', 'Fever', 'General Checkup',
 1000.00);

 Alter table aj_hospital_table
 drop column cost;
--check the tablke and its contents
describe table aj_hospital_table ;
SELECT * FROM aj_hospital_table;

update  aj_hospital_table
set patient_name = 'Akash Dere'
where patient_id=1;
...
--Show the cost of each treatment (without showing personally identifying information about specificpatients):
